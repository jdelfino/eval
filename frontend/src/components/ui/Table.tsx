...
const TableHeader = forwardRef<HTMLTableSectionElement, TableHeaderProps>(
  ({ className, children, ...props }, ref) => {
    return (
      <thead
        ref={ref}
        className={cn('bg-[var(--bg-sunken)]', className)}
        {...props}
      >
        {children}
      </thead>
...
const TableRow = forwardRef<HTMLTableRowElement, TableRowProps>(
  ({ className, children, ...props }, ref) => {
    return (
      <tr
        ref={ref}
        className={cn('hover:bg-[var(--bg-sunken)] transition-colors', className)}
        {...props}
      >
        {children}
      </tr>
  ...
  ({ align = 'left', className, children, ...props }, ref) => {
    return (
      <th
        ref={ref}
        className={cn(
          'px-4 py-3 text-xs font-medium text-[var(--fg-muted)] uppercase tracking-wider',
