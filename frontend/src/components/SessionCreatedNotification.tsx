...
export default function SessionCreatedNotification() {
  ...
  return (
    <div
      className="bg-info-soft border border-info rounded-lg p-4 flex items-center justify-between"
    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="p-1 text-info hover:brightness-110 transition-colors"
          aria-label="Dismiss"
