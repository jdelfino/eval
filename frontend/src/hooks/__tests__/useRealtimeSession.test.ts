...
describe('useRealtimeSession', () => {
  ...
  describe('Centrifugo event handling', () => {
    ...
    it('should store test_cases from student_code_updated event on the student', async () => {
      ...
      expect(result.current.students[0].test_cases).toBeUndefined();

      const testCases = [{ name: 'Case 1', input: 'hello inputs', match_type: 'exact', order: 0, random_seed: 42 }];
      act(() => {
        simulatePublication('student_code_updated', {
          user_id: 'student-1',
          code: 'print("hello")',
    ...
    it('should store test_cases from student_code_updated in pending updates (out-of-order)', async () => {
      ...
      const testCases = [{ name: 'Case 1', input: 'pending inputs', match_type: 'exact', order: 0 }];
    ...
    it('should handle featured_student_changed event', async () => {
      ...
      const testCases = [{ name: 'Case 1', input: 'hello world', match_type: 'exact', order: 0 }];
