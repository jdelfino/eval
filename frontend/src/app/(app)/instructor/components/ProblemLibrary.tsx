...
export default function ProblemLibrary({ onCreateNew, onEdit }: ProblemLibraryProps) {
  ...
  const handleSessionCreated = (session_id: string, _joinCode: string) => {
    ...
    // Navigate directly to the session dashboard
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div className="flex flex-wrap items-center justify-between gap-3" data-testid="problem-library-header">
        <div>
        ...
        <div className="flex flex-wrap items-center gap-3" data-testid="problem-library-controls">
          {classes.length > 0 && (
