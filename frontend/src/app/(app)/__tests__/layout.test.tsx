/**
 * Tests for the app layout — verifies PreviewProvider wrapping and auth behavior.
 *
...
jest.mock('@/components/SessionCreatedNotification', () => {
  const SessionCreatedNotification = () => <div data-testid="session-notification" />;
  return { __esModule: true, default: SessionCreatedNotification };
});
